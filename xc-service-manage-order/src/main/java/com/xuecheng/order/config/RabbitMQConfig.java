...
public class RabbitMQConfig {
     ...
     */
    @Bean
    public Binding binding_finishaddcourse_processtask(@Qualifier("xc_learning_finishaddchoosecourse") Queue queue, @Qualifier(EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange) {
     ...
     */
    @Bean
    public Binding binding_addcourse_processtask_2(@Qualifier("xc_learning_addchoosecourse") Queue queue, @Qualifier(EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange) {
