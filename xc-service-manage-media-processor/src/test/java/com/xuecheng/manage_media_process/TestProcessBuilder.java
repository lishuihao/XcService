...
//        processBuilder.command("java","-jar","f:/xc-service-manage-course.jar");
    ...
    public void testUtils(){
        String path="D:\\ffmpeg-20180227-fa0c9d6-win64-static\\bin\\ffmpeg.exe";
        String video_path="G:\\ffmpeg_test\\lucene.avi";
        String mp4_name="1.mp4";
        String mp4Path="G:\\ffmpeg_test\\";
        Mp4VideoUtil mp4VideoUtil = new Mp4VideoUtil(path,video_path,mp4_name,mp4Path);
